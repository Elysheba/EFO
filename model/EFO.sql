...
-- -----------------------------------------------------
-- Table `EFO`.`EFO_entryId`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EFO`.`EFO_entryId` (
...
-- -----------------------------------------------------
-- Table `EFO`.`EFO_crossId`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EFO`.`EFO_crossId` (
  ...
  CONSTRAINT `fk_crossId_entryId`
    FOREIGN KEY (`DB1` , `id1`)
    REFERENCES `EFO`.`EFO_entryId` (`DB` , `id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `EFO`.`EFO_parentId`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EFO`.`EFO_parentId` (
...
-- -----------------------------------------------------
-- Table `EFO`.`EFO_idNames`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EFO`.`EFO_idNames` (
...
-- -----------------------------------------------------
-- Table `EFO`.`EFO_sourceFiles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EFO`.`EFO_sourceFiles` (
  `url` VARCHAR(45) NOT NULL COMMENT 'URL location of the source files',
  `current` VARCHAR(45) NOT NULL COMMENT 'Date of the current (or used) version of the source files',
  PRIMARY KEY (`url`))
ENGINE = InnoDB;
